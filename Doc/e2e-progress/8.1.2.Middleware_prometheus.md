...
Không cần chỉnh gì thêm: /metrics nằm chung port API (8080). Nếu ACE vừa đổi port host để tránh xung đột (8081:8080), thì Prometheus sẽ scrape http://localhost:8081/metrics trên máy ACE.
...
///////==============Bước 6- sửa lại devices bootstrap
package bootstrap
